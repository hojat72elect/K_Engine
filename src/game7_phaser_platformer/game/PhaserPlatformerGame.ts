...
export class PhaserPlatformerGame extends Scene {
    ...
    preload() {
        this.load.image('sky', 'assets/game7_phaser_platformer/sky.png');
        this.load.image('ground', 'assets/game7_phaser_platformer/platform.png');
        this.load.image('star', 'assets/game7_phaser_platformer/star.png');
        this.load.image('bomb', 'assets/game7_phaser_platformer/bomb.png');
        this.load.spritesheet('dude', 'assets/game7_phaser_platformer/dude.png', {frameWidth: 32, frameHeight: 48});
    }
