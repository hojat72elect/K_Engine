...
export class Preloader extends Scene {
    ...
    init() {
        ...
        const bar: Phaser.GameObjects.Rectangle = this.add.rectangle(512 - 230, 384, 4, 28, 0xffffff);
    ...
    preload() {
        ...
        this.load.setPath('assets/game2_coin_clicker');
    ...
    create() {
        //  When all the assets have been loaded, it's often worth creating global objects here that the rest of the game can use.
