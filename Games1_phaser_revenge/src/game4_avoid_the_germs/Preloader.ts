export default class Preloader extends Phaser.Scene {
    ...
    preload() {
        ...
        // Use regular text for loading screen since bitmap font isn't loaded yet
        this.loadText = this.add.text(400, 300, 'Loading ...', { fontSize: '32px', color: '#ffffff' }).setOrigin(0.5);

        // Load the slime bitmap font
        this.load.setPath('assets/game4_avoid_the_germs/games/germs/');
        ...
        //  Audio ...
        this.load.setPath('assets/game4_avoid_the_germs/games/germs/sounds/');
    ...
    create() {
        ...
        if (this.sound.locked) {
            this.loadText.text = 'Click to Start';
